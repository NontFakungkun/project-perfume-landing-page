    ...
    <footer className='max-container'>
        <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
            <div className='flex flex-col items-start'>
                ...
                <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'>Discover your ideal fragrance for the new season at our nearest store. Find your perfect scent and enjoy rewards.</p>
